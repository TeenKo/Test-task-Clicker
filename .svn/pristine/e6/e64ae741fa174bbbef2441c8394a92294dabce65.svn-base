...
using System.Text;
using Core.DeveloperConsole.Scripts.Backend;
using Core.DeveloperConsole.Scripts.Common;
using UnityEngine;

namespace Core.DeveloperConsole.Scripts.Gui
{
#pragma warning disable 0649
    ...
    internal class ConsoleGui
    {
        ...
        internal void Update()
        {
            ...
            InputToggleConsole = UnityEngine.Input.GetKeyDown(m_options.ConsoleKey);
