...
{
    public sealed class VoodooGameLevelFinishReactSystem : ReactiveSystem<AnalyticEntity>
    {
        private readonly AnalyticContext _analyticContext;

        public VoodooGameLevelFinishReactSystem(AnalyticContext analyticContext) : base(analyticContext)
        {
