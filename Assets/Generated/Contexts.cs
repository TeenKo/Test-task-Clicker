...
public partial class Contexts : Entitas.IContexts {
    ...
    public AdvertisementContext advertisement { get; set; }
    public AnalyticContext analytic { get; set; }
    public AudioContext audio { get; set; }
    public GameContext game { get; set; }
    public InAppPurchaseContext inAppPurchase { get; set; }
    public InputContext input { get; set; }
    public LevelContext level { get; set; }
    public StateContext state { get; set; }
    public UiContext ui { get; set; }

    public Entitas.IContext[] allContexts { get { return new Entitas.IContext [] { advertisement, analytic, audio, game, inAppPurchase, input, level, state, ui }; } }

    public Contexts() {
        advertisement = new AdvertisementContext();
        analytic = new AnalyticContext();
        audio = new AudioContext();
        game = new GameContext();
        inAppPurchase = new InAppPurchaseContext();
...
public partial class Contexts {
    ...
    public void InitializeContextObservers() {
        try {
            CreateContextObserver(advertisement);
            CreateContextObserver(analytic);
            CreateContextObserver(audio);
            CreateContextObserver(game);
            CreateContextObserver(inAppPurchase);
