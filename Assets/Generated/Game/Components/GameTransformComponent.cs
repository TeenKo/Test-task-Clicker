...
public partial class GameEntity {
    ...
    public Core.Common.TransformComponent transform { get { return (Core.Common.TransformComponent)GetComponent(GameComponentsLookup.Transform); } }
    ...
    public void AddTransform(UnityEngine.Transform newValue) {
        ...
        var component = (Core.Common.TransformComponent)CreateComponent(index, typeof(Core.Common.TransformComponent));
