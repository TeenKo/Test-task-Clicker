...
public partial class GameEntity {
    ...
    public Core.Common.RigidbodyComponent rigidbody { get { return (Core.Common.RigidbodyComponent)GetComponent(GameComponentsLookup.Rigidbody); } }
    ...
    public void AddRigidbody(UnityEngine.Rigidbody newValue) {
        ...
        var component = (Core.Common.RigidbodyComponent)CreateComponent(index, typeof(Core.Common.RigidbodyComponent));
